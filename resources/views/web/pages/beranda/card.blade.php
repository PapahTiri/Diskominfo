<section class="flex flex-col rounded-none">
    <div class="flex flex-col items-center px-20 pt-20 pb-9 w-full bg-indigo-900 max-md:px-5 max-md:max-w-full">
        <div class="flex flex-col w-full max-w-[1072px] max-md:max-w-full">
            <h2 class="self-center text-4xl font-semibold leading-loose text-right text-white">
                Berita
            </h2>
